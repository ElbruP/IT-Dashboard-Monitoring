...
const KATEGORIEFARBEN = {
    "cve":                "#f2555a",
    "sicherheitswarnung": "#f0705a",
    "eol":                "#f0a33e",
    "update":             "#2dd4bf",
    "produktinformation": "#8b7fd4",
    "sonstiges":          "#5a6472"
};
...
function zurAnmeldung() { /* In der Vorfuehrung gibt es keine Anmeldung. */ }
...
async function aktualisieren() {
    try {
        ...
        Diagramm.verlauf(document.getElementById("trend"),
            daten.trend.map(t => ({
                beschriftung: `KW ${t.kalenderwoche}`, wert: t.anzahl
            })));
